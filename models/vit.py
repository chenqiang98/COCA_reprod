...
def get_vit_timm(model_name='vit_base_patch16_224', pretrained=True):
...
vit_base_patch16_224 = lambda pretrained=True: get_vit_timm('vit_base_patch16_224', pretrained)
